...
class TestHelpers(TestController):
    ...
    def test_gravatar(self):
        ...
        expected =['<a href="https://gravatar.com/"',
                '<img src="https://gravatar.com/avatar/7856421db6a63efa5b248909c472fbd2?s=200&amp;d=mm"', '</a>']
    ...
    def test_gravatar_config_set_default(self):
        ...
        expected =['<a href="https://gravatar.com/"',
                   '<img src="https://gravatar.com/avatar/7856421db6a63efa5b248909c472fbd2?s=200&amp;d=%s"' % default,
                   '</a>']
        # Hash the email address
        import hashlib
        email_hash = hashlib.md5(email).hexdigest()
    ...
    def test_gravatar_encodes_url_correctly(self):
        ...
        expected =['<a href="https://gravatar.com/"',
                   '<img src="https://gravatar.com/avatar/7856421db6a63efa5b248909c472fbd2?s=200&amp;d=http%3A%2F%2Fexample.com%2Fimages%2Favatar.jpg"',
                   '</a>']
        # Hash the email address
        import hashlib
        email_hash = hashlib.md5(email).hexdigest()
